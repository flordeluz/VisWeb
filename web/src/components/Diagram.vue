    ...
    return {
      ...
      macroTasks: [
        ...
        },
        {
          ...
          tasks: [
            { name: 'Trend', value: 'trend', active: true, required: true },
            {
              name: 'Cyclicity',
              value: 'cyclicity',
              active: true,
        ...
        this.macroTaskStages[this.nextStage].forEach(i => {
          ...
          let labelTemplate = `
            <table>
              ...
              class="border taskName ${
                macroTask.disabled ? 'disabled' : 'toChoose'
              }"
              data-id="${i}">
                ${macroTask.taskName}
              </td>
      ...
      <table class="macroTask">
        <tr>
            ${actions
              .map(
                action =>
                  `<td id="macro-${action.value}" class="border icon-inactive ${
                    action.active ? 'action active' : ''
                  } ${action.required ? 'required' : ''}"
                  data-value="${action.value}" data-macroTask="${taskName}" ${
                    action.active
              ...
              .join(' ')}
            <td rowspan = "2">
            <span" class="mdi mdi-arrow-right-drop-circle-outline arrow"></span>
          ...
          <tr >
            <td colspan="${
              actions.length
            }" style="vertical-align:middle;" class="border taskName" >${taskName}
            </td>
        </tr>
