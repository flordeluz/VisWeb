...
<v-container fluid>
  ...
  <v-row v-if="chart" justify="center" dense>
    <v-col class="text-center text-h5 text-capitalize">Range: {{ this.chart.options.axisX.viewportMinimum }} - {{ this.chart.options.axisX.viewportMaximum }}</v-col>
  </v-row>
  <v-row>
    <!-- <v-col cols="1"> -->
...
export default {
	...
	this.tareasHechas = []
	console.log("[ Time chart object ]:", this.$refs.timeChart)
	// this.showGuide()
    }
}
</script>
