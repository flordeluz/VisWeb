<template>
  <v-app>
    <v-app-bar color="primary" app clipped-left>
      <v-toolbar-title class="white--text"> <h1>VisWeb</h1></v-toolbar-title>

      <v-spacer></v-spacer>
      <v-btn class="mr-2" router to="/" outlined color="white">Home</v-btn>

      <v-btn router to="spiral" outlined color="white">Spiral</v-btn>
    </v-app-bar>
