...
* TODO Visual Analytics Guidance Development

** TODO Spiral diagram analysis improvement

- Compute segments and timespan for the Spiral. *Done*.

- Multiple time series integration. *Done*.

- Fix polygon coordinates when there are more than three dimensions. *In progress*.

** TODO Independent section for statistics

- Statistics of the time series (size, nulls, type of columns, or dimensions). *In progress*.

- Distribution type of the time series (e.g., normal). *In progress*.

- Outliers. *In progress*.

- Correlation matrix. *In progress*.

** TODO Flow diagram improvement

- Data cleaning, Normalization and transformation, and Time-series behavior. *Done*.

- Stoppers and prereqs control between stages of the Guidance flow. *In progress*.
...
| *Module*                 | *Functions*                                                                                              |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| AlgoritmosLimpieza       | obtener\textunderscore ruido\textunderscore de(DF, int): bool                                            |
|                          | obtener\textunderscore ruido\textunderscore cv(DF, float): bool                                          |
|                          | obtener\textunderscore ruido\textunderscore ri(DF): bool                                                 |
|                          | obtener\textunderscore outlier\textunderscore zscore(DF, int): bool                                      |
|                          | grubbs\textunderscore max\textunderscore test(DF, float): bool, float                                    |
|                          | grubbs\textunderscore min\textunderscore test(DF, float): bool, float                                    |
|                          | obtener\textunderscore outlier\textunderscore grubbs(DF, float): bool                                    |
|                          | obtener\textunderscore outlier\textunderscore dixon(DF): bool                                            |
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarLimpieza(DF): bool, string                                                                      |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| algoritmosNormalizacion  | obtener\textunderscore estacionaria\textunderscore mv(DF, float): bool                                   |
|                          | obtener\textunderscore no\textunderscore patrones\textunderscore estacionalidad(DF, int): bool           |
|                          | def obtener\textunderscore distribucion\textunderscore conocida(DF): bool                                |
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarNormalizacion(DF): bool, string                                                                 |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| algoritmosTransformacion | obtener\textunderscore no\textunderscore estacionariedad\textunderscore adf(DF, float): bool             |
...
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarTransformacion(DF): bool, string                                                                |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| algoritmosReduccion2     | verificar\textunderscore correlacion\textunderscore pearson(DF, float): bool                             |
...
|                          | verificar\textunderscore linealidad(DF, float): bool                                                     |
|                          | verificar\textunderscore linealidad\textunderscore regression(DF, float): bool                           |
|                          | verificar\textunderscore linealidad\textunderscore pca(DF, float): bool                                  |
|                          | verificar\textunderscore linealidad\textunderscore acf(DF, float): bool                                  |
|                          | verificar\textunderscore linealidad\textunderscore pacf(DF, float): bool                                 |
|                          | verificar\textunderscore estacionariedad\textunderscore adf(DF, float): bool                             |
|                          | verificar\textunderscore estacionariedad\textunderscore kpss(DF, float): bool                            |
|                          | verificar\textunderscore estabilidad\textunderscore descomposicion(DF, float): bool                      |
|                          | verificar\textunderscore estabilidad\textunderscore lsvr(DF, float): bool                                |
|                          | verificar\textunderscore dimensionality\textunderscore reduction\textunderscore pca(DF, float): bool     |
|                          | verificar\textunderscore dimensionality\textunderscore reduction\textunderscore fa(DF, int, float): bool |
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarReduccion(DF): bool, string                                                                     |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| algoritmosEstacionalidad | check\textunderscore box\textunderscore pierce(Series, float): bool                                      |
|                          | verificar\textunderscore box\textunderscore pierce(DF): bool                                             |
|                          | check\textunderscore box\textunderscore pierce2(Series, float): bool                                     |
|                          | verificar\textunderscore box\textunderscore pierce2(DF): bool                                            |
|                          | check\textunderscore periodicity\textunderscore fft(Series, float): bool                                 |
|                          | verificar\textunderscore periodicidad\textunderscore fft(DF): bool                                       |
|                          | check\textunderscore periodicity\textunderscore fft2(Series): bool                                       |
|                          | verificar\textunderscore periodicidad\textunderscore fft2(DF): bool                                      |
|                          | check\textunderscore periodicity\textunderscore fft3(Series): bool                                       |
|                          | verificar\textunderscore periodicidad\textunderscore fft3(DF): bool                                      |
|                          | check\textunderscore periodicity\textunderscore acf\textunderscore pacf(Series, float): bool             |
|                          | verificar\textunderscore periodicidad\textunderscore acf\textunderscore pacf(DF): bool                   |
|                          | check\textunderscore wavelet\textunderscore periodicity(Series, float): bool                             |
|                          | verificar\textunderscore periodicidad\textunderscore wavelet(DF): bool                                   |
|                          | check\textunderscore seasonal\textunderscore periodicity(Series, int, float): bool                       |
|                          | verificar\textunderscore descomposiocion\textunderscore stl(DF, int): bool                               |
|                          | fisher\textunderscore seasonality\textunderscore test(Series, float): bool                               |
|                          | verificar\textunderscore estacionalidad\textunderscore fisher(DF): bool                                  |
|                          | check\textunderscore amplitude(Series, float): bool                                                      |
|                          | verificar\textunderscore amplitud(DF): bool                                                              |
|                          | check\textunderscore amplitude\textunderscore fft(Series, float): bool                                   |
|                          | verificar\textunderscore amplitud\textunderscore fft(DF): bool                                           |
|                          | check\textunderscore frequency\textunderscore fft(Series, float): bool                                   |
|                          | verificar\textunderscore frecuencia\textunderscore fft(DF): bool                                         |
|                          | check\textunderscore frequency\textunderscore acf(Series, float): bool                                   |
|                          | verificar\textunderscore frecuencia\textunderscore acf(DF): bool                                         |
|                          | determine\textunderscore timespan(DF, float): bool                                                       |
|                          | verificar\textunderscore duracion(DF): bool                                                              |
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarEstacionalidad(DF): bool, string                                                                |
|--------------------------+----------------------------------------------------------------------------------------------------------|
| algoritmosCiclicidad2    | detecta\textunderscore ciclo(Series, float): bool                                                        |
|                          | verificar\textunderscore ciclo\textunderscore fft(DF): bool                                              |
|                          | consistencia\textunderscore ciclo\textunderscore fft(Series, int, float): bool                           |
|                          | verificar\textunderscore consistencia\textunderscore fft(DF): bool                                       |
|                          | consistencia\textunderscore ciclo\textunderscore acf(Series, int, float): bool                           |
|                          | verificar\textunderscore consistencia\textunderscore acf(DF): bool                                       |
|                          | verificar\textunderscore consistencia\textunderscore forma\textunderscore duracion(DF): bool             |
|                          | consistencia\textunderscore ciclo\textunderscore varianza(Series, int, float): bool                      |
|                          | verificar\textunderscore consistencia\textunderscore varianza(DF): bool                                  |
|                          | consistencia\textunderscore ciclo\textunderscore pearsonr(Series, array, int, float): bool               |
|                          | sinusoidal(array, array, array, array, array): array                                                     |
|                          | forma\textunderscore ciclos\textunderscore sinusoidal(Series, int, float): bool                          |
|                          | verificar\textunderscore ciclos\textunderscore sinusoidal(DF): bool                                      |
|                          | frecuencia\textunderscore ciclos\textunderscore fft(Series, float, float): bool                          |
|                          | verificar\textunderscore frecuencia\textunderscore fft(DF): bool                                         |
|                          | frecuencia\textunderscore ciclos\textunderscore acf(Series, int, int): bool                              |
|                          | verificar\textunderscore frecuencia\textunderscore acf(DF): bool                                         |
|                          | ejecutarFuncionesMultihilo(DF, list): None                                                               |
|                          | comprobarCiclicidad(DF): bool, string                                                                    |
\rmfamily
...
|-------------------------------------------------------------------------+---------------|
| Integrate data and cache repositories with the front end.               | /In Progress/ |
|-------------------------------------------------------------------------+---------------|
